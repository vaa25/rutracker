    ...
    public static void main(String[] args) {
        ...
        if (IOManager.readUserInput(
            ...
            try {
                if (files.size() > 1) {
                    tp.setTorrentData(
                            IOManager.readUserInput(
                                    "Enter tracker announce url: "),
                            Integer.parseInt(IOManager.readUserInput(
                                    "Enter piece length: ")),
                            IOManager.readUserInput(
                ...
                IOManager.save(
                        tp.generateTorrent(),
                        (userInput = IOManager.readUserInput("Save torrent as: "))
                );
            ...
            if ((userInput = IOManager.readUserInput(
                ...
                if (!(userInput = IOManager.readUserInput(
                    ...
                    if (userInput.matches("2")) {
                        ...
                        filename =
                                "/download.php?id=627079&name=Final%20Fantasy%20VII%20Advent%20Children%20(DUBBED)(ws)(DVDRIP)[TV-M]";
